...
const u8 gRaticateAlolaPokedexText[] = _(
    ...
    "Zwischen den Gruppen, die jeweils ihr\n"
    "eigenes Territorium besitzen, entbrennen\n"
    "oft Kämpfe um Futter.");
#else
const u8 gRaticateAlolaPokedexText[] = _(
...
const u8 gMarowakAlolaPokedexText[] = _(
    "Die Knochen in seinem Besitz stammen von\n"
    "der Mutter. Nach ihrem Tod wurde ihre\n"
    "Trauer zu Flammen, die Knogga nun\n"
    "schützen.");
#else
const u8 gMarowakAlolaPokedexText[] = _(
...
const u8 gEeveePokedexText[] = _(
    ...
    "STEINe führt zur Entwicklung dieses Pkmn.");
#else
const u8 gEeveePokedexText[] = _(
...
const u8 gArceusPokedexText[] = _(
    "Die Mythologie erzählt, dass dieses\n"
    "Pokémon geboren wurde, bevor das\n"
    "Universum überhaupt existierte.");
#else
const u8 gArceusPokedexText[] = _(
...
const u8 gGenesectPokedexText[] = _(
    ...
    "mächtigste aller Jäger gefürchtet. Es\n"
    "wurde von Team Plasma umgemodelt.");
#else
const u8 gGenesectPokedexText[] = _(
...
const u8 gGreninjaPokedexText[] = _(
    ...
    "Drehgeschwindigkeit beim Werfen sogar\n"
    "Metall durchtrennen.");
#else
const u8 gGreninjaPokedexText[] = _(
...
const u8 gScatterbugPokedexText[] = _(
    ...
    "angegriffen, verstreut es schwarzen\n"
    "Puder. Der giftige Puder löst bei Berührung\n"
    "Paralyse aus.");
#else
const u8 gScatterbugPokedexText[] = _(
...
const u8 gSpewpaPokedexText[] = _(
    ...
    "Wird es von einem Feind angegriffen, stellt\n"
    "es sein Fell zur Abschreckung zu scharfen\n"
    "Spitzen auf.");
#else
const u8 gSpewpaPokedexText[] = _(
...
const u8 gFurfrouPokedexText[] = _(
    ...
    "nicht nur schöner, sondern auch\n"
    "beweglicher.");
#else
const u8 gFurfrouPokedexText[] = _(
...
const u8 gXerneasPokedexText[] = _(
    ...
    "Leben spenden. In Gestalt eines Baumes\n"
    "ist es aus seinem tausendjährigen Schlaf\n"
    "erwacht.");
#else
const u8 gXerneasPokedexText[] = _(
...
const u8 gZygarde50PokedexText[] = _(
    "Es wird gemutmaßt, dass es von seiner\n"
    "Höhle aus all jene beobachtet, die dem\n"
    "Ökosystem Schaden zufügen.");
#else
const u8 gZygarde50PokedexText[] = _(
...
const u8 gZygarde10PokedexText[] = _(
    "Es greift seine Beute mit spitzen\n"
    "Fangzähnen an. Da es diese Form nicht\n"
    "lange beibehalten kann, zerfällt es nach\n"
    "einer Weile in seine Bestandteile.");
#else
const u8 gZygarde10PokedexText[] = _(
...
const u8 gGumshoosPokedexText[] = _(
    "Findet es Spuren potenzieller Beute, legt\n"
...
const u8 gVikavoltPokedexText[] = _(
    "Es fliegt umher und wartet auf seine\n"
    "Chance. In seinem großen Kiefer speichert\n"
    "es elektrische Energie, die es auf Feinde\n"
    "abfeuern kann.");
#else
const u8 gVikavoltPokedexText[] = _(
...
const u8 gRibombeePokedexText[] = _(
    "Dieses Pokémon rollt Blütenstaub zu\n"
    "Kugeln. Manche dieser Pollenknödel dienen\n"
    "als Nahrung, andere setzt es aber auch im\n"
    "Kampf ein.");
#else
const u8 gRibombeePokedexText[] = _(
...
const u8 gRockruffPokedexText[] = _(
    ...
    "frischgebackenen Trainern empfohlen. Mit\n"
    "dem Alter wird es jedoch immer wilder.");
#else
const u8 gRockruffPokedexText[] = _(
...
const u8 gAraquanidPokedexText[] = _(
    ...
    "Kopfstöße. Kleine Pokémon werden dabei\n"
    "hineingezogen und ertrinken.");
#else
const u8 gAraquanidPokedexText[] = _(
...
const u8 gLurantisPokedexText[] = _(
    "Es erfordert viel Arbeit, seine\n"
    "Farbenpracht zu erhalten, doch zum Glück\n"
    "gibt es Passionierte, die den hohen\n"
...
const u8 gSilvallyNormalPokedexText[] = _(
    "Das Vertrauen zu seinem Trainer weckt\n"
...
const u8 gSilvallyMemoryPokedexText[] = _(
    "Es hat seine Kontrollmaske selbst\n"
    "zerstört. Nun kann es seinen Typ ändern,\n"
    "indem es sich mit speziellen Speicherdaten\n"
    "ausrüstet.");
#else
const u8 gSilvallyMemoryPokedexText[] = _(
...
const u8 gMiniorMeteorPokedexText[] = _(
    ...
    "wenn seine Schale zu schwer wird, stürzt\n"
    "es auf die Erde.");
#else
const u8 gMiniorMeteorPokedexText[] = _(
...
const u8 gTogedemaruPokedexText[] = _(
    ...
    "Rücken an, aber wenn es sich aufregt,\n"
    "stellen sie sich auf und stechen\n"
    "angreifende Gegner.");
#else
const u8 gTogedemaruPokedexText[] = _(
...
const u8 gMimikyuBustedPokedexText[] = _(
    ...
    "Mimigma selbst ist nur im übertragenen\n"
    "Sinne geknickt.");
#else
const u8 gMimikyuBustedPokedexText[] = _(
...
const u8 gAlcremieVanillaCreamPokedexText[] = _(
    "Es macht einem Trainer, dem es vertraut,\n"
    "mit Beeren samt Sahnedekoration eine\n"
    "Freude.");
#else
const u8 gAlcremieVanillaCreamPokedexText[] = _(
...
const u8 gAlcremieRubyCreamPokedexText[] = _(
    "Bei der Entwicklung wurden seine\n"
    "Körperzellen verquirlt, wodurch es einen\n"
    "süßsauren Geschmack angenommen hat.");
#else
const u8 gAlcremieRubyCreamPokedexText[] = _(
...
const u8 gAlcremieMatchaCreamPokedexText[] = _(
    "Bei der Entwicklung wurden seine\n"
    "Körperzellen verquirlt, wodurch es einen\n"
    "aromatischen Geschmack angenommen hat.");
#else
const u8 gAlcremieMatchaCreamPokedexText[] = _(
...
const u8 gAlcremieMintCreamPokedexText[] = _(
    "Bei der Entwicklung wurden seine\n"
    "Körperzellen verquirlt, wodurch es einen\n"
    "erfrischenden Geschmack angenommen hat.");
#else
const u8 gAlcremieMintCreamPokedexText[] = _(
    "The moment it evolved, it took on a\n"
...
const u8 gAlcremieLemonCreamPokedexText[] = _(
    "Bei der Entwicklung wurden seine\n"
    "Körperzellen verquirlt, wodurch es einen\n"
    "säuerlichen Geschmack angenommen hat.");
#else
const u8 gAlcremieLemonCreamPokedexText[] = _(
    "The moment it evolved, it took on a\n"
...
const u8 gAlcremieSaltedCreamPokedexText[] = _(
    "Bei der Entwicklung wurden seine\n"
    "Körperzellen verquirlt, wodurch es einen\n"
    "salzigen Geschmack angenommen hat.");
#else
const u8 gAlcremieSaltedCreamPokedexText[] = _(
    "The moment it evolved, it took on a\n"
...
const u8 gAlcremieRubySwirlPokedexText[] = _(
    "Bei der Entwicklung wurden seine\n"
    "Körperzellen verquirlt, wodurch es einen\n"
    "vielseitigen Geschmack angenommen hat.");
#else
const u8 gAlcremieRubySwirlPokedexText[] = _(
    "The moment it evolved, it took on a\n"
...
const u8 gAlcremieCaramelSwirlPokedexText[] = _(
    "Bei der Entwicklung wurden seine\n"
    "Körperzellen verquirlt, wodurch es einen\n"
    "bitteren Geschmack angenommen hat.");
#else
const u8 gAlcremieCaramelSwirlPokedexText[] = _(
    "The moment it evolved, it took on a\n"
...
const u8 gAlcremieRainbowSwirlPokedexText[] = _(
    "Bei der Entwicklung wurden seine\n"
    "Körperzellen verquirlt, wodurch es einen\n"
    "komplexen Geschmack angenommen hat.");
#else
const u8 gAlcremieRainbowSwirlPokedexText[] = _(
    "The moment it evolved, it took on a\n"
...
const u8 gToxtricityGigantamaxPokedexText[] = _(
    ...
    "Pokémon ist sogar mehr Strom gespeichert\n"
    "als in einer Gewitterwolke.");
#else
const u8 gToxtricityGigantamaxPokedexText[] = _(
...
const u8 gOgerponWellspringMaskPokedexText[] = _(
    "Diese Form glänzt in Offensive und\n"
    "Defensive. Wie das sprudelnde Wasser eines\n"
    "Springbrunnens greift dieses Pokémon\n"
    "Gegner pausenlos an.");
#else
const u8 gOgerponWellspringMaskPokedexText[] = _(
...
const u8 gOgerponCornerstoneMaskPokedexText[] = _(
    ...
    "spezialisiert. Wie das Fundament eines\n"
    "Hauses fängt dieses Pokémon jegliche\n"
    "Stöße solide ab.");
#else
const u8 gOgerponCornerstoneMaskPokedexText[] = _(
