...
extern const u8 EventScript_NoSurfLicense[];
extern const u8 EventScript_NoDiveLicense[];
...
extern const u8 Common_EventScript_HnsNormanCall[];
extern const u8 Common_EventScript_HnsMomCall[];
